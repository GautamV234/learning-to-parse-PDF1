...
def run_pix2tex(img):
    ...
    parser.add_argument('-c', '--config', type=str, default='settings/colab.yaml')
    parser.add_argument('-m', '--checkpoint', type=str, default='model/checkpoints/weights.pth')
